...
```{r echo=FALSE, message=FALSE, warning=FALSE, results='asis'}
cat('
The analysis was conducted using the **non-profit pipelines** [BioRedis-engine](https://github.com/jkubis96/BioRedis_engine) and custom [scripts](https://github.com/jkubis96/BioRedis_engine/tree/main/benchmark/scripts) developed by **Jakub Kubiś**.  
